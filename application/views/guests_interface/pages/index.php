		...
		<div class="main clearfix">
			...
			<div class="main-block clearfix">
				<div class="container">
					<div class="row">
						<div class="span12">
							<h1 class="h">Офисный центр. Аренда офисных помещений от собственника</h1> 
							<p>
								Ведь в этом случае значительно уменьшается арендная плата, возрастает уверенность в качестве предложенных услуг и гарантируется ответственность за оказание их не в полном объеме. 
								Обычно цена за квадратный метр очень сильно зависит не только от состояния арендуемого помещения, но и от удаленности его от центра. 
								Тем не менее существует реальная возможность <a href="<?=site_url('arenda-v-biznes-centre');?>">выгодной аренды помещений в Ростове</a>, в районе с развитой инфраструктурой с отличной возможностью быстрого выезда в центр города и на крупные магистрали. 
								Район аренды - Нахичевань, один из самых экологически чистых и быстроразвивающихся в городе. Именно поэтому стоит обратить внимание на предложение от офисного центра «Нахичеванские линии». 
								Являясь собственником здания, бизнес-центр предлагает <a href="<?=site_url('arenda-v-biznes-centre');?>">аренду офисных помещений по доступным ценам </a> — от 450 рублей за кв.м. <a href="/ofisi-v-arendu-rostov">Аренда помещений от собственника</a> в этом случае предполагает 
								еще и наличие дополнительных преимуществ:
							</p>
							<ul>
								<li>охраняемая парковка и свободный подъезд любых видов транспорта, от легкового до грузового;</li>
								<li>автономное отопление и электроснабжение, что делает здание независимым от теплоцентралей и существенно влияет на арендную плату;</li>
								<li>наличие систем кондиционирования помещений — необходимое условие в климатическом поясе Ростова-на-Дону;</li>
								<li>возможность арендовать складские помещения на близлежащей территории делает предложение привлекательным для производственных и торговых фирм;</li>
							</ul>
							<h2 class="h"><a href="/pomechenie-v-arendu">Аренда помещений без посредников</a> — мечта любого предпринимателя</h2>
							<p>
								Бизнес-центр «Нахичеванские линии» находится на первой линии домов и имеет удобный выезд в центр города и на такие магистрали, как пр. Шолохова и трассу М-4. 
								Развитая инфраструктура района делает бизнес-центр очень удобным для работы, позволяя легко добираться до него как работникам, так и клиентам. 
								В шаговой доступности находятся продуктовые магазины, магазины товаров первой необходимости. «Нахичеванские линии» — это современное многоэтажное здание, площадью 5704 кв.м. 
								<a href="<?=site_url('pomechenie-v-arendu-pod-ofis');?>">В аренду предлагаются офисы</a> от 8 до 110 кв.м. Каждое помещение отремонтировано с учетом требований безопасной и комфортной организации труда. В отделке использованы только качественные экологически 
								чистые стройматериалы. «Нахичеванские линии» - это именно то, что заинтересует клиентов, стремящихся сочетать выгодную цену и высокое качество предлагаемых услуг. 
								<a href="<?=site_url('pomechenie-v-arendu-pod-ofis');?>">Арендовать помещения в бизнес-центре</a> не только удобно, но и престижно.
								<a href="<?=site_url('arenda-pomecheniya-fizicheskim-licom');?>">«Аренда помещения физическим лицом</a>. Звоните нам прямо сейчас!»
							</p>
						</div>
					</div>
					...
					<div class="row">
						<div class="span12">
							<div class="main-text" id="first-main-text">
								<h2>Бизнес-центр «Нахичеванские линии». <a href="/arenda-ofisa-ot-sobstvennika">Аренда офисов Ростов</a></h2>
							</div>
							<div class="main-text">
								<p>
