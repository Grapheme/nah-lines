		...
		<div class="main clearfix">
			...
			<div class="main-block clearfix">
				<div class="container">
					<div class="row">
						<div class="span12">
							<h1 class="h">Аренда помещений без посредников — мечта любого предпринимателя.</h1> 
							<p>
							...
							<h2 class="h">Аренда помещений без посредников — мечта любого предпринимателя.</h2>
							<p>
					...
					<div class="row">
						<div class="span12">
							<div class="main-text" id="first-main-text">
								<h2>Бизнес-центр «Нахичеванские линии». Аренда офисов Ростов.</h2>
							</div>
							<div class="main-text">
								<p>
